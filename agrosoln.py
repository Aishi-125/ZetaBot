# -*- coding: utf-8 -*-
"""
Created on Fri Apr 19 23:48:50 2024
...
words = pickle.load(open("E:/Rubybot/words.pkl", 'rb'))
classes = pickle.load(open("E:/Rubybot/classes.pkl", 'rb'))
intents = json.loads(open("E:/Rubybot/inputs.json").read())
model = keras.models.load_model("E:/Rubybot/chatbot.h5")
